...
- Added safe `readbased_postprocess_options` forwarding with a default `--min_coverage 0.05`, explicit cross-parameter validation, and support for both `_1/_2` and `_R1/_R2` directory input pairing.
