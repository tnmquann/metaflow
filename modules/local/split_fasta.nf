process SPLIT_FASTA {
    ...
    python ${projectDir}/bin/py_scripts/assembly_based/split_fasta.py $unbinned ${params.min_length_unbinned_contigs} ${params.max_unbinned_contigs} ${params.min_contig_size}
